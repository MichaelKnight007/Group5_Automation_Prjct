...
public class Driver_original {
    private Driver_original(){
        /*
    ...
    public static void closeDriver(){
        if (driver!=null){
            driver.quit();//This line will terminate the existing session, value will not be given null.
            driver=null; //We are assigning the driver as null ourselves to make sure when quit() closes the session,
